...
from typing import TYPE_CHECKING, Any, ClassVar, NoReturn, Type
...
class Variant(metaclass=VariantMeta):
    ...
    def __init_subclass__(cls) -> None:
        ...
        for name, annotation in annotations.items():
            ...
            nc.__match_args__ = tuple(f"_{index}" for index in range(len(annotation)))
    ...
    def __eq__(self, other: object):
        ...
        return all(getattr(self, arg) == getattr(other, arg) for arg in self.__match_args__)
